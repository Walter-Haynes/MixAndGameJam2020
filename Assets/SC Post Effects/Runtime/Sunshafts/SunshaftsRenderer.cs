        ...
        class SunshaftsRenderPass : PostEffectRenderer<Sunshafts>
        {
            ...
            public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
            {
                ...
                if(res != downsampling)
                {
                    ...
                    cmd.GetTemporaryRT(mainTexID.id, resolution.x / res, resolution.y / res, 0, FilterMode.Bilinear);
                ...
                Blit(this, cmd, mainTexID.id, skyboxBufferID, Material, (int)SunshaftsBase.Pass.SkySource);
                ...
                FinalBlit(this, context, cmd, mainTexID.id, cameraColorTarget, Material, (int)SunshaftsBase.Pass.Blend);
            }
