    ...
    public class LensFlaresRenderer : ScriptableRendererFeature
    {
        class LensFlaresRenderPass : PostEffectRenderer<LensFlares>
        {
            ...
            public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
            {
                ...
                FinalBlit(this, context, cmd, mainTexID.id, cameraColorTarget, Material, (volumeSettings.debug.value) ? (int)Pass.Debug : (int)Pass.Blend);
            }
        ...
        {
            m_ScriptablePass = new LensFlaresRenderPass();
